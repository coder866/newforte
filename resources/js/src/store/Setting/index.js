...
const state = {
  ...
  lang: { title: 'English', value: 'en', image: '@/assets/images/small/flag-01.png'},
  langOption: [
    { title: 'English', value: 'en', image: '@/assets/images/small/flag-01.png'},
    { title: 'Arabic', value: 'ar', image: '@/assets/images/small/flag-500.png'},
    { title: 'Chinese', value: 'chi', image: '@/assets/images/small/flag-300.png'},
    { title: 'Hindi', value: 'hi', image: '@/assets/images/small/flag-100.png'},
    { title: 'Greek', value: 'gr', image: '@/assets/images/small/flag-400.png'},
    { title: 'Franch', value: 'fr', image: '@/assets/images/small/flag-200.png'}
  ],
  colors: [
